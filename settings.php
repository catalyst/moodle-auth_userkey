...
if ($ADMIN->fulltree) {
    ...
    $settings->add(new admin_setting_configtext('auth_userkey/ipwhitelist',
        get_string('ipwhitelist', 'auth_userkey'),
        get_string('ipwhitelist_desc', 'auth_userkey'), ''));
    $settings->add(new admin_setting_configtext('auth_userkey/redirecturl',
        get_string('redirecturl', 'auth_userkey'),
        get_string('redirecturl_desc', 'auth_userkey'), ''));
    $settings->add(new admin_setting_configtext('auth_userkey/ssourl',
